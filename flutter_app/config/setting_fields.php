    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'AddWeb Solution', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
                ...
                'class' => '', // any class for input
                'value' => '<a href="https://www.addwebsolution.com/">Developed by AddWeb Solution</a>', // default value if you want
            ],
            [
    ...
    'meta' => [
        ...
        'elements' => [
            [
                ...
                'class' => '', // any class for input
                'value' => 'Awesome Laravel | A Flutter Project', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'https://www.addwebsolution.com/themes/custom/addweb/addweb-logo-web.png', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => '', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '@addweb', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
