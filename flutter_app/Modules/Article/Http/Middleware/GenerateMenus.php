...
class GenerateMenus
{
    ...
    public function handle($request, Closure $next)
    {
        \Menu::make('admin_sidebar', function ($menu) {
            ...
            // Articles Dropdown
            $articles_menu = $menu->add('<i class="nav-icon far fa-lightbulb"></i> '.__('Tips & Suggestions'), [
                'class' => 'nav-group',
            ])
            ->data([
                'order'         => 81,
            ...
            // Submenu: Posts
            $articles_menu->add('<i class="nav-icon far fa-lightbulb"></i> '.__('Tips & Suggestions'), [
